...
export const UI_LOCALES = {
  zh: {
    ...
    'objectList.workcaseDynamicStages': '执行、自检、复核',
    'objectList.workcaseStageExecute': '执行',
    'objectList.workcaseStageSelfCheck': '自检',
    'objectList.workcaseStageResultReview': '复核',
  ...
  en: {
    ...
    'objectList.workcaseDynamicStages': 'Execution, self-check, and result review',
    'objectList.workcaseStageExecute': 'Execute',
    'objectList.workcaseStageSelfCheck': 'Self-check',
    'objectList.workcaseStageResultReview': 'Result review',
