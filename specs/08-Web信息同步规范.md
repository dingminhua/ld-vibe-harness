...
Web 主要服务 V5、V6、V7 和 V8，并支撑 V1、V2 和 V3：它把事实源状态、风险、证据、验证结果和回写边界以适合场景的范式呈现给 Human，帮助 AI 获得明确、可解析、可回指的确认结果。Web 的直接服务对象是 Human，但它仍服务 00 的 AI 第一目标；Web 页面状态不是事实源，也不替代 AI 判断或 Human Gate。
