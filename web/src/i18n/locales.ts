...
export const UI_LOCALES = {
  zh: {
    ...
    'cognition.commitHotspots.empty': '该时间范围内没有可回指提交的事实对象',
    ...
    'cognition.commitHotspots.clusterSummary': '主热点 {commits} 条提交 · 围绕它展开 {work} 项工作',
    'cognition.commitHotspots.commitRefs': '可回指提交',
  ...
  en: {
    ...
    'cognition.commitHotspots.empty': 'No fact objects can be traced back from commits in this time range',
    ...
    'cognition.commitHotspots.clusterSummary': 'Primary hotspot · {commits} commits · {work} related work items',
    'cognition.commitHotspots.commitRefs': 'Traceable commits',
