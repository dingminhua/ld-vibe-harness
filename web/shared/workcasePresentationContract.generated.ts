...
export const WORKCASE_PRESENTATION_CONTRACT_IDENTITY = "workcase-current-snapshot-presentation/2" as const;
...
export const WORKCASE_PHASE_HANDOFF = {
  "human_plan_confirming": {
