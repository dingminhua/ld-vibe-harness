...
> 相关规范：`specs/11-LDVH-AI协作规范.md`、`specs/11.01-Rules机制规范.md`、`specs/11.02-Skill机制规范.md`、`specs/11.03-Agent机制规范.md`、`specs/12-LDVH工具基础规范.md`、`specs/50-LDVH工作流基础规范.md`、`specs/51-multi-role-thinking-多角色思考.md`
