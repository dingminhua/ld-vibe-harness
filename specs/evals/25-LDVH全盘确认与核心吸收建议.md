...
| 平台、产品方向与 Skill | 10 Codex、11 Gstack-Trae 共识、12 规范即机制、13 系统结构、14 第三方 Skill、15 Trae Spec、16 Skill 写作 | 平台边界、Core Loop、Task 治理锚点、Skill 生命周期化 |
| 深度调研与 Web / 理念 | 19 Gstack 深调、20 Superpowers、21 BMAD、22 Web 页面、23 00 理念重梳、24 Hermes | 验证铁律、反合理化、微文件、Web 三层、AI 第一体验、工具权限面 |
...
### 4.12 工具执行证据层与 closure_evidence 结构化
...
### 10.1 P0：应尽快进入正式规范或 Rules / Skill 改造
