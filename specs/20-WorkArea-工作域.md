...
ldvh_doc:
  ...
  parent_doc: ""
  relation: ""
  positioning: "定义 WorkArea / 工作域工作模型，包括对象定位、准入条件、事实源边界、状态机、对象关系、Human Gate、字段契约、事实源回写和适配规则"
  scope: "所有接入 LDVH 且需要长期管理工作范围、系统领域、治理域或产品域的项目"
  basis:
...
| 工作域字段内容格式 | `specs/05.02-工作模型字段内容与格式规范.md` |
