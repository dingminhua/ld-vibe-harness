...
> 规范来源：`docs/specs/04.07-AI统一入口运行投影规范.md`
...
6. 需要创建、修改或删除 LDVH 自身项目运行投影时，读取 `LDVH-ENVIRONMENT-INITIALIZATION.md`、`docs/specs/04-规范落地与环境适配基础规范.md`、`docs/specs/04.02-环境适配与运行投影规范.md`、`docs/specs/04.03-环境适配映射与运行投影记录模板.md` 和 `docs/specs/04.07-AI统一入口运行投影规范.md`；
7. 需要处理平台适配、平台清单或要求响应矩阵时，读取 `docs/specs/04.08-平台适配清单规范.md`，当前平台为 Trae Solo 时读取 `docs/specs/04.09-Trae-Solo适配清单.md`；
...
| 修改 docs/specs 正式规范 | `docs/specs/03-文档基础规范.md`、`docs/specs/03.01-规范文档规范.md`、`docs/specs/04.01-规范落地要求规范.md`、`docs/specs/41-landing-orchestration-规范落地统筹.md`，以及目标规范 |
...
| 执行产品初始化 | `docs/specs/42-product-initialization-产品初始化.md`、`docs/specs/04.08-平台适配清单规范.md`、当前平台适配清单；当前平台为 Trae Solo 时读取 `docs/specs/04.09-Trae-Solo适配清单.md` |
...
| 处理规范落地、环境适配、平台清单或运行投影 | `docs/specs/04-规范落地与环境适配基础规范.md`、`docs/specs/04.01-规范落地要求规范.md`、`docs/specs/04.02-环境适配与运行投影规范.md`、`docs/specs/04.03-环境适配映射与运行投影记录模板.md`、`docs/specs/04.05-LDVH落地特别要求.md`、`docs/specs/04.07-AI统一入口运行投影规范.md`、`docs/specs/04.08-平台适配清单规范.md`、当前平台适配清单和 `docs/specs/41-landing-orchestration-规范落地统筹.md` |
| 执行产品审计 | `docs/specs/43-product-audit-产品审计.md`、`docs/specs/42-product-initialization-产品初始化.md`、`docs/specs/04.08-平台适配清单规范.md`、当前平台适配清单和 `docs/specs/40-工作流程集合索引.md` |
...
1. `docs/specs/04.07-AI统一入口运行投影规范.md`；
2. `docs/specs/04.05-LDVH落地特别要求.md`；
