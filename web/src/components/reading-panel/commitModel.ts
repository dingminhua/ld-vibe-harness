...
const COMMIT_SIGNATURE_TRAILER = /(?:^|\n)\s*(?:LDVH-Product-Name|LDVH-Model-Name|LDVH-Agent-Runtime-Name|Session-ID|Signer-Type|Agent-ID|Host-Environment|Model-ID|Agent-Workbench|Workbench-Name):\s*/i;
