...
若工作目标是处理 WorkArea、WorkPlan、ADR、Memo、Pitfall 或 Study 等工作对象，应转入 `rules/LDVH-WORKSPACE-ENTRY.md`；若目标是追溯事实源修改，应读取 Git commit records 和 `specs/09.01-Git提交记录与变更追溯规范.md`。
