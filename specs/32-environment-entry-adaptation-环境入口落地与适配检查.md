...
v2_action_member:
  ...
  capability_assets:
    - "type=rule; path=rules/LDVH-RUNTIME-PROTOCOL.md; purpose=统一 Runtime Protocol 入口，薄引用目标; status=required"
...
5. 需要评估本文 active 后是否触发 `rules/LDVH-RUNTIME-PROTOCOL.md` 的入口表达同步；
