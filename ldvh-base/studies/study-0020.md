...
updated_at: '2026-08-03T17:47:21.463140+08:00'
---
...
在 LDVH 规范层面（如 specs/08 或新增呈现规范）定义一次"回复可视化使用纪律"：何时使用（关系、对比、流程、结构）、使用什么结构、避免什么（图表不承载结论、解释留正文）、主题明暗与无障碍要求。验收条件：纪律内容可被任一环境接入后无歧义消费。
