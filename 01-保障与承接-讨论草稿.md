...
### 6.2 Receipt、Evidence、Diagnostic
...
## 8. 当前 01 可能还需要继续理清的问题

### 8.1 01 是不是应该显式定义“保障需求生命周期”
...
### 8.3 01 是否应该把 Hook 机制抽象成 Runtime 消费模型
