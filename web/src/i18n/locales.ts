...
export const FIELD_VALUE_LOCALES: Record<string, Record<string, { zh: string; en: string }>> = {
  ...
  reviewer: {
    'independent-result-review-subagent': { zh: '独立结果复核', en: 'Independent Result Review' },
    workcase_creation_review: { zh: '独立方案复核', en: 'Independent Plan Review' },
  },
  category: {
...
export const UI_LOCALES = {
  zh: {
    ...
    'objectDetail.workcaseNextControlStep.complete_independent_result_review': '完成独立结果复核',
    ...
    'objectDetail.workcaseCreationReviewsBoundary': '复核者对当前计划提供独立第二视角；复核判断不等于 Human 的执行决定。',
    ...
    'objectDetail.workcaseControllerCheckBoundary': '记录主控的技术自检；不等于独立复核或 Human 验收。',
    'objectDetail.workcaseResultReviews': '独立结果复核',
    'objectDetail.workcaseResultReviewsBoundary': '复核者对当前结果版本提供独立第二视角；主控的反馈处置另行记录。',
  ...
  en: {
    ...
    'objectDetail.workcaseNextControlStep.complete_independent_result_review': 'Complete independent result review',
