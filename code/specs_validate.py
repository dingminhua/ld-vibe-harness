...
def _fast_v2_check_main(argv):
    ...
    parser.add_argument("--input-scope", choices=["active_specs", "specs_v2", "all", "history_specs_v1", "governed_projects"], default="active_specs", help="知识地图输入范围，默认 active_specs；specs_v2 保留为兼容别名。Git 历史查询使用原生 Git，不作为知识地图输入范围。")
...
def build_parser():
    ...
    v2_parser.add_argument("--input-scope", choices=["active_specs", "specs_v2", "all", "history_specs_v1", "governed_projects"], default="active_specs", help="知识地图输入范围，默认 active_specs；specs_v2 保留为兼容别名。Git 历史查询使用原生 Git，不作为知识地图输入范围。")
