...
Task 的准入、状态和字段契约由 `docs/specs/27-Task-任务.md` 定义。Pitfall 不替代 Task 的验收标准、验证证据、关闭证据、风险判断或缺陷修复动作。
...
Profile 的准入、状态和字段契约由 `docs/specs/26-Profile-项目画像.md` 定义。
