...
先识别任务类型，再按 00-08 读原文片段：00 定位/价值；01 目录/编号；02 术语；03 specs/索引；04 事实源边界；05 Trae Solo 环境规范；06 Python/Web工具；07 工作模型；08 工作流程。定位章节先搜标题行号，再按行范围读；工具输出、网页、聊天记忆不替代 Git 事实源；与任务主题相关的 evals/refs 应先读取（见 05 §6.6）。
