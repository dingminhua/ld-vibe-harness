...
export const UI_LOCALES = {
  zh: {
    ...
    'cognition.recent.truncated': '共 {total} 条动态，显示前 {shown} 条，{hidden} 条未显示',
  ...
  en: {
    ...
    'cognition.recent.truncated': '{total} activities in total; showing the first {shown}, {hidden} not shown',
