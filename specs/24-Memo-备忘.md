...
> 相关规范：`specs/05.01-工作字段内容格式规范.md`、`specs/07-Code确定性执行实现规范.md`、`specs/08-Web信息同步实现规范.md`、`specs/20-WorkArea-工作域.md`、`specs/21-WorkPlan-工作计划.md`、`specs/22-ADR-决策.md`、`specs/09.01-Git提交记录与变更追溯规范.md`、`specs/25-Study-研究报告.md`
