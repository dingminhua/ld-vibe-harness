...
V4 Web 默认只读。准备保留、隔离、替换或重新开放任何写入前，必须回到当前有效来源，确认目标对象、允许变化、前置条件、当次授权、实际 Code 能力、操作前呈现、操作后回读、失败和部分结果边界。具体调查、实现和测试顺序记录在 [`V4-工作推进总纲.md`](../../docs/v4-architecture/V4-工作推进总纲.md)，不由本文制定。
