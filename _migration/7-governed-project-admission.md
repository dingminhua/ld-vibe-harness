...
| 产物 | 内容 |
|---|---|
| `specs/10-安装与配置规范.md` | 管辖项目配置、工作对象判定、多目标边界、事实源入口和环境引用边界 |
