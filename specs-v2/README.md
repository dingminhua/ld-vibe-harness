...
| `01.Att.04-规范身份字段与状态闭集表.md` | 承载 01 授权的规范身份字段、附件身份字段、状态闭集和身份辅助核对表 | draft，未 active |
| `01.Att.05-行动编排接管建议矩阵.md` | 承载 01 授权的普通保障要求与行动编排接管关系、建议行动编排实例矩阵和接管写法 | draft，未 active |
| `01.Att.06-表达清单.md` | 承载 01 授权的不推荐表达、替代写法、中文定语规则和表达辅助核对表 | draft，未 active |
| `02.Att.01-字段注册表.md` | 承载 02 授权的字段注册表结构、注册列闭集、字段生命周期、废弃/别名/替代关系和消费元数据 | draft，未 active |
| `02.Att.02-事实模型成员身份字段表.md` | 承载 02 授权的事实模型成员身份字段表和成员字段闭集辅助说明 | draft，未 active |
| `02.Att.03-事实模型成员规范骨架模板.md` | 承载 02 授权的事实模型成员主文件专属骨架模板 | draft，未 active |
| `02.Att.04-事实模型成员一致性辅助核对表.md` | 承载 02 授权的事实模型成员一致性辅助核对表 | draft，未 active |
| `02.Att.05-事实模型成员双读映射矩阵.md` | 承载 02 授权的 active `ldvh_member` 与 v2 `v2_fact_model_member` 双读映射矩阵 | draft，未 active |
| `02.Att.06-字段矩阵诊断表.md` | 承载 02 授权的字段 x 模型矩阵诊断目标、判断标准和辅助核对表 | draft，未 active |
| `02.Att.07-清退对象与废弃字段登记表.md` | 承载 02 授权的已清退对象、旧入口和废弃字段登记清单 | draft，未 active |
