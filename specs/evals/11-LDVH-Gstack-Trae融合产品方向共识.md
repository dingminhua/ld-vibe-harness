...
> 回流状态：本节第 2-4 条已回流到 11 系列正式规范，分别由 `specs/11-LDVH-Trae-Solo-环境规范.md`、`specs/11-LDVH-Trae-Solo-环境规范.md` §6 和 `specs/11-LDVH-Trae-Solo-环境规范.md` §7 承接；本文保留为产品方向入口摘要，不替代正式规范。
