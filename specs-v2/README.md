...
| `01.Att.04-身份元信息契约表.md` | 承载 01 授权的规范身份、附件身份、状态闭集和身份辅助核对信息 | draft，未 active |
| `01.Att.05-行动编排接管建议矩阵.md` | 承载 01 授权的普通保障要求与行动编排接管关系、建议行动编排实例矩阵和接管写法 | draft，未 active |
| `01.Att.06-规范表达清单.md` | 承载 01 授权的不推荐表达、替代写法、中文定语规则和表达辅助核对信息 | draft，未 active |
...
| `02.Att.07-清退登记表.md` | 承载 02 授权的清退对象、旧入口和废弃字段登记清单 | draft，未 active |
