...
> 上位规范：[`specs/05-Web信息同步规范.md`](../../specs/05-Web信息同步规范.md)、[`specs/08-测试基础规范.md`](../../specs/08-测试基础规范.md)

## 0. 上位规范

`specs/05-Web信息同步规范.md` 是 LDVH Web 信息同步构成要素、派生视图、Human Gate UI、受控轻写入白名单和 Web 文档边界的权威规范。`specs/08-测试基础规范.md` 是跨构成要素测试治理、验证声明、测试实现归属和测试证据事实源边界的权威规范。
...
1. 读取 `specs/05-Web信息同步规范.md`、`specs/08-测试基础规范.md`、`web/docs/01-全局设计约束.md` 和当前页面对应文档；
