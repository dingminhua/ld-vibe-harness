...
| 处理规范落地、环境适配或运行投影 | `docs/specs/04-规范落地与环境适配基础规范.md`、`docs/specs/04.01-规范落地要求规范.md`、`docs/specs/04.02-环境适配与运行投影规范.md`、`docs/specs/04.03-环境适配映射与运行投影记录模板.md`、`docs/specs/04.05-LDVH落地特别要求.md`、`docs/specs/04.07-AI统一入口运行投影规范.md`、`docs/specs/41-landing-orchestration-规范落地统筹.md` |
...
场景同时命中多个入口时，选择最小足够读取集。只要涉及正式规范变更、落地缺口、运行投影漂移、产品初始化或产品审计输入，应优先进入 `docs/specs/41-landing-orchestration-规范落地统筹.md`。
