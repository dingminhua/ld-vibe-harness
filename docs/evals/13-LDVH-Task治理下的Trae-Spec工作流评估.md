...
> 相关评估：`specs/evals/21-LDVH全盘确认与核心吸收建议.md`、`specs/refs/trae/06-Spec与Plan工作流.md`
...
```text
Output Contract:
- Primary artifact: specs/evals/13-LDVH-Task治理下的Trae-Spec工作流评估.md
- Required changes:
  - 新文档存在
  - 旧 20 号文档不存在
...
|---|---|---|
| specs/evals/13-...md | exists | ls specs/evals |
