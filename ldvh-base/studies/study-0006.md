...
source_refs:
- kind: web-page
  locator: https://github.com/DeusData/codebase-memory-mcp
  observed_at: '2026-07-19T10:00:00+08:00'
- kind: web-page
  locator: https://tree-sitter.github.io/tree-sitter/
  observed_at: '2026-07-19T10:00:00+08:00'
- kind: web-page
  locator: https://github.com/tree-sitter/tree-sitter
  observed_at: '2026-07-19T10:00:00+08:00'
evidence_refs:
- kind: web-page
  locator: https://github.com/DeusData/codebase-memory-mcp
...
updated_at: '2026-07-19T11:17:49.581725+08:00'
---
...
本报告读取并对照了以下外部公开资料：https://github.com/DeusData/codebase-memory-mcp、https://tree-sitter.github.io/tree-sitter/、https://github.com/tree-sitter/tree-sitter。观察时间统一记录在 evidence_refs；本报告只陈述页面可直接支持的内容，并将 LDVH 适用性与外部事实分开。
## 关键发现
